...
import type { ParseOptions } from 'ember-estree'
import type * as EmberESTree from 'ember-estree'

// @unocss-include

export const emberEstreeGJS: Parser<typeof EmberESTree, ParseOptions> = {
  id: 'ember-estree-gjs',
  ...
  parse(code, options) {
    ...
    return (result as { program: EmberESTree.ASTNode }).program ?? result
  },
  editorLanguage: 'glimmer-js',
  getNodeLocation,
}

export const emberEstreeGTS: Parser<typeof EmberESTree, ParseOptions> = {
  id: 'ember-estree-gts',
